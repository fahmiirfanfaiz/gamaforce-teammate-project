...
const Button = () => {
  return (
    <div className="fixed left-4 top-1/4 flex flex-col space-y-2 p-2 bg-white shadow-lg rounded-lg">
      {/* Point Button */}
